        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                <div class="sidebar-brand-icon rotate-n-15">
                    <img src="img/VAULTNEW.png" style="width: 5rem">
                </div>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                     ...
                     <!--   <li class="nav-item dropdown no-arrow mx-1">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small">Inventory</span>
                ...
                <div class="container-fluid">
                    ...
                    <select name="id_wine_cellar" id="" style="height: 2rem; width: 17rem">
                    <option value="volvo">Winery 1</option>
                    <option value="saab">Winery 2</option>
                    <option value="mercedes">Winery 3</option>
                    <option value="audi">Winery 4</option>
                    </select>
